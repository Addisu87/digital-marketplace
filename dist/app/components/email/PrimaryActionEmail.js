    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Body, { className: 'bg-white font-sans' },
            React.createElement(components_1.Container, { className: 'mx-auto py-20 px-0' },
                React.createElement(components_1.Img, { src: `${process.env.NEXT_PUBLIC_SERVER_URL}/hippo-newsletter-sign-up.png`, width: '150', height: '150', alt: 'DigitalMarketPlace', className: 'mx-auto' }),
...
const PrimaryActionEmailHtml = (props) => (0, components_1.render)(React.createElement(exports.EmailTemplate, Object.assign({}, props)), {
    pretty: true,
});
